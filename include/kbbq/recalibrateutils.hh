...
kmer_cache_t find_trusted_kmers(htsiter::HTSFile* file, const bloom::bloomary_t& sampled, std::vector<int> thresholds, int k, uint64_t chunksize = -1);
...
covariateutils::CCovariateData get_covariatedata(htsiter::HTSFile* file, const bloom::bloomary_t& trusted, int k);
